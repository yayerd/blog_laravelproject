...
<div class="container my-4 mx-6">
    <div class="row d-flex justify-content-center align-items-center">
        <div class=" p-4 border mt-2 col-sm-8">
            <form action="/categorie/putarticle" method="POST">
                @csrf 
                <div class="form-group">
                    <label for="categorie" class="form-label mt-4">Ajouter un nouvel article</label>
                    <input name="titreArticle" type="text" class="form-control" id="categorie" aria-describedby="categorie" placeholder="Titre de l'article">
                  ...
                  <div class="form-group">
                    ...
                    <textarea name="contenuArticle" class="form-control" id="contenuTextarea" rows="3"></textarea>
                  </div>
                  <div class="form-group">
